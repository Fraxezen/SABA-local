...
encoder_weights = bucket.blob('lstm_enc_test_bindo.h5')
decoder_weights = bucket.blob('lstm_dec_test_bindo.h5')
json_answer = bucket.blob('answers.json')
data_vector = bucket.blob('data.npz')
json_question = bucket.blob('questions.json')
encoder_weights.download_to_filename('/tmp/lstm_enc_test_bindo.h5')
decoder_weights.download_to_filename('/tmp/lstm_dec_test_bindo.h5')
...
encoder.load_weights('/tmp/lstm_enc_test_bindo.h5')
decoder=create_decoder(VocabSize,EmbeddingSize,N_Unit)
decoder.load_weights('/tmp/lstm_dec_test_bindo.h5')
